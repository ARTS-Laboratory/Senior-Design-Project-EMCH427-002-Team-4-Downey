#ifndef __real_time_test_sfun_h__
#define __real_time_test_sfun_h__
...
extern mxArray* load_real_time_test_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_real_time_test_optimization_info(void);
